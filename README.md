...
![Estado antes del ataque](before_attack.png)

### Durante el Ataque

![Ejecución del script](during_attack.png)

![Bindings falsos](bindings.png)

Se aprecian los bindings falsos con MACs aleatorias.

### Después del Ataque

![Pool agotado](pool_exhausted.png)

El Pool de la VLAN 20 se ha agotado, ya que se han entregado todas las direcciones IP.

![Víctima sin IP](victim_no_ip.png)
